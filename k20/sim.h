...
#define SIM_SOPT1    MMIO_32(0x40047000)
...
#define SIM_SOPT4    MMIO_32(0x4004800C)
...
#define SIM_SOPT5    MMIO_32(0x40048010)
...
#define SIM_SOPT7    MMIO_32(0x40048018)
...
#define SIM_SDID	MMIO_32(0x40048024)

#define SIM_SCGC4	MMIO_32(0x40048034)
...
#define SIM_SCGC5	MMIO_32(0x40048038)
...
#define SIM_SCGC6	MMIO_32(0x4004803C)
#define SIM_SCGC6_RTC	(1 << 29)
#define SIM_SCGC6_ADC0	(1 << 27)

#define SIM_SCGC7	MMIO_32(0x40048040)

#define SIM_CLKDIV1	MMIO_32(0x40048044)
#define SIM_CLKDIV2	MMIO_32(0x40048048)

#define SIM_FCFG1	MMIO_32(0x4004804C)
#define SIM_FCFG2	MMIO_32(0x40048050)

#define SIM_UIDH	MMIO_32(0x40048054)
#define SIM_UIDMH	MMIO_32(0x40048058)

#define SIM_UIDML	MMIO_32(0x4004805C)
#define SIM_UIDL	MMIO_32(0x40048060)
