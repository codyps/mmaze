## base.mk: 2e9604c, see https://github.com/jmesmon/trifles.git
# Usage:
#
# == Targets ==
# 'all'
...
# $(TARGETS_SLIBS)  a list of static libraries (created using AR).
#
...
# TARGET_BINS should be used in new code
TARGET_BINS ?= $(TARGETS)
TARGETS_ALL = $(TARGET_BINS) $(TARGET_SLIBS)
...
# $2 = another var to tack on, typically the command name
...
$(foreach obj,$(obj-$(1)),cflags-$(obj:.o=) += $(cflags-$(1)))
$(foreach obj,$(obj-$(1)),cxxflags-$(obj:.o=) += $(cxxflags-$(1)))
endef

# $1 = bin name ("foo")
# $2 = output dir
define BIN-LINK
$(call build-link-flags,$(1))

$2/$1$(BIN_EXT) : $2/.TRACK-LDFLAGS $(call target-obj,$(1),$2)
	$$(QUIET_LINK)$$(CCLD) -o $$@ $$(call target-obj,$(1),$2) $$(ALL_LDFLAGS) $$(ldflags-$(1))

all:: $2/$1$(BIN_EXT)

.PHONY: $2/$1$(BIN_EXT).clean
$2/$1$(BIN_EXT).clean :
	$$(RM) $$(call target-obj,$1,$2) $2/$1$(BIN_EXT) $$(TARGET_TRASH) $$(call target-dep,$1)
endef
...
$(2)/$(1) : $(2)/.TRACK-ARFLAGS $(call target-obj,$(1),$2)
	$$(QUIET_AR)$$(AR) -o $$@ $$(call target-obj,$(1),$2) $$(ALL_ARFLAGS) $$(arflags-$(1))

all:: $2/$1

.PHONY: $2/$1$(BIN_EXT).clean
$2/$1.clean :
	$$(RM) $$(call target-obj,$1,$2) $2/$1 $$(TARGET_TRASH) $$(call target-dep,$1)
endef
...
$(foreach target,$(TARGET_BINS),$(call BIN-LINK,$(target),$2))
$(foreach slib,$(TARGET_STATIC_LIBS),$(call SLIB-LINK,$(slib),$2))
endef
...
%.install: %
	mkdir -p $(BINDIR)
	install $* $(BINDIR)
install: $(foreach target,$(TARGET_BINS),$(target).install)
endif

obj-all = $(foreach target,$(TARGET_BINS),$(obj-$(target)))
obj-trash = $(foreach obj,$(obj-all),$(call OBJ_TRASH,$(obj)))

.PHONY: clean
clean:	$(addsuffix .clean,$(TARGET_BINS))
	$(RM) $(TRASH) $(obj-trash)
